...
public class BarAdapter extends RecyclerView.Adapter<BarAdapter.MyViewHolder> {
    ...
    public BarAdapter(Context mContext, List<Icon> iconList, OnItemClickListener mListener) {
        this.mContext = mContext;
        this.iconList = iconList;
        this.mListener = mListener;
    }
    private String[] titles = {"首页","全部服务","新闻","个人中心"};
    @NonNull
    @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull BarAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        Glide.with(mContext)
